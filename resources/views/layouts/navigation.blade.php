    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    @can('create', App\Models\Vacante::class)
                        <a class="mr-2 w-7 h-7 bg-green-600 hover:bg-green-800 rounded-xl flex flex-col justify-center items-center
                ...
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    @if(auth()->user()->rol === 2)
                        <div class="flex gap-2 items-center p-3">
                            <a class="w-7 h-7 bg-green-600 hover:bg-green-800 rounded-xl flex flex-col justify-center items-center
                                        text-sm font-extrabold text-white" 
                                href="{{ route('notificaciones') }}">
                                {{ Auth::user()->unreadNotifications->count() }}
                            </a>
